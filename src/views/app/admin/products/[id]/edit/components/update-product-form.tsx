...
import { ImageInput } from "./update-image-input";
import { UpdateProductLoading } from "./update-product-loading";
  ...
  useEffect(() => {
    if (initialValues && !hasInitialized.current) {
      form.reset({
        ...
        status: initialValues.status as "New" | "Used",
        categoryName: initialValues.categoryName,
        brandName: initialValues.brandName,
        images: initialValues.images,
      });
